...
WSGI_APPLICATION = 'pvcloud.wsgi.application'
...
# Password validators (keep defaults)
...
# CORS - tweak in prod
CORS_ALLOW_ALL_ORIGINS = not bool(os.environ.get('CORS_ORIGINS'))
